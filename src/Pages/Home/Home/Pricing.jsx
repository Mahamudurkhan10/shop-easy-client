...
const Pricing = () => {
     return (
          <div className="mt-7">
               <section className="bg-gray-600 container mx-auto py-12">
                         ...
                         <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                              ...
                              <div className="bg-gray-800 rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
                                   <div className="mb-8">
                                        ...
                                        <p className="mt-4 text-gray-400">Custom solutions for large organizations.</p>
                                   </div>
                                   <div className="mb-8">
                                   ...
                                   <ul className="mb-8 space-y-4 text-gray-400">
                                        <li className="flex items-center">
                                             ...
                                             <span>Custom user accounts</span>
                                        </li>
                                        <li className="flex items-center">
                                             <svg className="h-6 w-6 text-green-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
